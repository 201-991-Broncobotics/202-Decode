...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        //TODO: Tune This Colton - Mael
        public double parYTicks = -1091.45457283; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2808.42150042; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public TwoDeadWheelLocalizer(HardwareMap hardwareMap, IMU imu, double inPerTick, Pose2d initialPose) {
        ...
        perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "diffy")));
